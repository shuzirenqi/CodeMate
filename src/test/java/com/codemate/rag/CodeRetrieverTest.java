...
class CodeRetrieverTest {
    ...
    private static final String TEST_PROJECT = "/tmp/codemate-code-retriever";
    private VectorStore store;

    @BeforeEach
    void setUp() throws Exception {
        System.setProperty("codemate.rag.dir", "/tmp/codemate-test-rag-retriever");
